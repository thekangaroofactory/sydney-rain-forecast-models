...
json_dict = {'nb_row': 0,'colname': [], 'coltype':[], 'nb_nan':[], 'ratio_nan':[], 'unique_str':[], 'range':None, 'mean':None}
json_dict['nb_row'] = nb_row
json_dict['colname'] = header_list
json_dict['coltype'] = list(list_col_types.values())
json_dict['nb_nan'] = list(list_nb_nan.values())
json_dict['ratio_nan'] = nan_ratio
json_dict['unique_str'] = list(list_unique_values.values())
json_dict['range'] = difference
json_dict['mean'] = mean
